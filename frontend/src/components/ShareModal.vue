<template>
  <PopupLayer title="分享笔记" width="min(540px, calc(100vw - 32px))" @close="$emit('close')">
    <div class="form-grid">
    ...
    <button class="sl-btn sl-btn--primary share-create-btn" @click="handleCreate">
      创建分享
    </button>
...
.share-create-btn { width: 100%; margin-top: 16px; }
.expiry-grid {
  display: grid;
